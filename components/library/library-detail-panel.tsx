    ...
    return (
      <aside className="surface-card sticky top-7 self-start p-5">
        <div className="px-4 py-10 text-center text-tertiary">
          <svg className="mx-auto mb-4 h-10 w-10 opacity-40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
            <path d="M14 2v6h6" />
          </svg>
          <p className="text-[13px] leading-[1.5]">Select an item to see details, the original note, and quick actions.</p>
        </div>
      </aside>
    );
  }
